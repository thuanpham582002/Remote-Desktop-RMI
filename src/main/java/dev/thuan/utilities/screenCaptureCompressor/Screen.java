package dev.thuan.utilities.screenCaptureCompressor;
...
public class Screen {
    ...
    private final HashMap<String, ScreenBlock> screenBlocks = new HashMap<String, ScreenBlock>();
    ...
    private final Vector<String> changedScreenBlocks = new Vector<String>();
