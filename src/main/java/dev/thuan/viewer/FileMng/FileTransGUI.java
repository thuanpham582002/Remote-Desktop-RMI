...
public class FileTransGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dev/thuan/images/no.png"))); // NOI18N
    ...
    private final SwingWorker sendingWorker = new SwingWorker() {
        @Override
    ...
    private final SwingWorker receivingWorker = new SwingWorker() {
        @Override
        protected Object doInBackground() throws Exception {
    ...
    public void Done() {
        ...
        jButtonClose.setIcon(new ImageIcon(getClass().
                getResource("/dev/thuan/images/exit.png")));
    ...
    public void updateData(long size) {
        ...
        jLabelFileCount.setText(index + "/"
                + count + " file(s)");
        jLabelTotalSize.setText(size / 1000 + " KB");
        jLabelDuration.setText(duration / 1000 + " Seconds");
        jLabelSpeed.setText(speed + " KB/S");
